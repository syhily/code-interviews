...
func Test_reorderListNode(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{node: common.New(1)},
			want: common.New(1),
		},
		{
			name: "Reorder odd list node",
			args: args{node: common.New(1, 3, 5, 7, 9, 11, 13)},
			want: common.New(1, 13, 3, 11, 5, 9, 7),
		},
		{
			name: "Reorder even list node",
			args: args{node: common.New(2, 4, 6, 8, 10, 12)},
			want: common.New(2, 12, 4, 10, 6, 8),
		},
	}
